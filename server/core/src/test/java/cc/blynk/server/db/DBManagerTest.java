...
public class DBManagerTest {
    ...
    public void testUpsertUser() throws Exception {
        ...
        try (Connection connection = dbManager.getConnection();
            ...
            while (rs.next()) {
                ...
                assertEquals("{\"subscription\":{\"isActive\":false,\"canMasquerade\":false}}", rs.getString("json"));
            }
            connection.commit();
        }
    }
    ...
    public void testUpsertUserFieldUpdated() throws Exception {
        ...
        assertEquals("{\"dashBoards\":[{\"id\":1,\"parentId\":-1,\"isPreview\":false,\"name\":\"123\",\"createdAt\":0,\"updatedAt\":0,\"theme\":\"Blynk\",\"keepScreenOn\":false,\"isAppConnectedOn\":false,\"isNotificationsOff\":false,\"isShared\":false,\"isActive\":false}],\"subscription\":{\"isActive\":false,\"canMasquerade\":false}}", user.profile.toString());
    }
    ...
    public void testInsertAndGetUser() throws Exception {
        ...
        assertEquals("{\"dashBoards\":[{\"id\":1,\"parentId\":-1,\"isPreview\":false,\"name\":\"123\",\"createdAt\":0,\"updatedAt\":0,\"theme\":\"Blynk\",\"keepScreenOn\":false,\"isAppConnectedOn\":false,\"isNotificationsOff\":false,\"isShared\":false,\"isActive\":false}],\"subscription\":{\"isActive\":false,\"canMasquerade\":false}}", dbUser.profile.toString());
