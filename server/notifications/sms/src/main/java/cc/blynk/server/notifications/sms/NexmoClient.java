...
/* An SmsClient that talks to the Nexmo service.
*/
public class NexmoClient implements SmsClient {

    private static final Logger log = LogManager.getLogger(NexmoClient.class);
    ...
    public NexmoClient(Properties props, AsyncHttpClient httpclient) {
        this(props.getProperty("nexmo.api.key"), props.getProperty("nexmo.api.secret"), httpclient);
    }

    private NexmoClient(String key, String secret, AsyncHttpClient httpclient) {
        this.key = key;
        this.secret = secret;
